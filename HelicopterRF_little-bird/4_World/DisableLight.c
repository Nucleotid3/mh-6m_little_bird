class ActionDisableLightHeliCB_little_bird : ActionContinuousBaseCB
{
...
class ActionHeliDisableLightRF_little_bird: ActionContinuousBase
{
	void ActionHeliDisableLightRF_little_bird()
	{
		m_CallbackClass = ActionDisableLightHeliCB_little_bird;
