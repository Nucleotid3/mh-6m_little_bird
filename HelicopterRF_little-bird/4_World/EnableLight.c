class ActionEnableLightHeliCB_little_bird : ActionContinuousBaseCB
{
...
class ActionHeliEnableLightRF_little_bird: ActionContinuousBase
{
	void ActionHeliEnableLightRF_little_bird()
	{
		m_CallbackClass = ActionEnableLightHeliCB_little_bird;
