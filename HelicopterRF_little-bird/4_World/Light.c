class HeliLightPanel_little_bird extends PointLightBase
{

	private static float m_DefaultBrightness = 7;
	private static float m_DefaultRadius = 0.5;
	
	void HeliLightPanel_little_bird()
	{
